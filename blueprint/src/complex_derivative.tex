...
\end{lemma}
\begin{proof}
  \uses{thm:cauchy_riemann, lem:vanishing_partial_derivatives}
  % \leanok
  \ldots
\end{proof}
...
\begin{lemma}[Harmonicity of real and imaginary parts]
  ...
  Then $u$ and $v$ are \term{harmonic functions},
  i.e., they satisfy % the \term{Laplace equation}
  \begin{align*}
...
\begin{definition}[Harmonic conjugate]
  ...
  \uses{def:analytic_function, lem:real_and_imaginary_parts_harmonic}
  % \lean{}
  % \leanok
  ...
  \term{harmonic conjugate} of $u$ if the function
  \begin{align*}
...
\begin{lemma}[Local existence of harmonic conjugates]
  \label{lem:harmonic_conjugate_existence}
  \uses{def:harmonic_conjugate, lem:real_and_imaginary_parts_harmonic}
  % \lean{}
  % \leanok
